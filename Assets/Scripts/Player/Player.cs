...
namespace Player
{
    public class Player : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("_bufferJumpWindow")]
        [Header("Buffer Jump")] 
        [SerializeField] private float bufferJumpWindow = 0.25f; // Окно буфера (сколько секунд допустимо)
        ...
        [FormerlySerializedAs("_coyoteJumpWindow")]
        [Header("Coyote Jump")] 
        ...
        {
            bool coyoteJumpAvalible = Time.time < _coyoteJumpActivated + coyoteJumpWindow; 
